    ...
    var body: some View {
        VStack {
            Button("Enter", action: {
                ...
                text += "Speed up by 20 on the Bike and 60 on the Truck."
                abike.accelerate(20)
...
class Bike: Vehicle {
    ...
    override init(_ startColour: String, _ startMaxSpeed: Int) {
        super.init(startColour, startMaxSpeed)
    }
